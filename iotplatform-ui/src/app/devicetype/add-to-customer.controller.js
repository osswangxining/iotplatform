 ...
 */
/*@ngInject*/
export default function AddDevicesToCustomerController(deviceTypeService, $mdDialog, $q, customerId, devices) {
    ...
    vm.theDevices = {
        ...
        fetchMoreItems_: function () {
            if (vm.devices.hasNext && !vm.devices.pending) {
                ...
                deviceTypeService.getTenantDevices(vm.devices.nextPageLink, false).then(
    ...
    function assign() {
        ...
        for (var deviceId in vm.devices.selections) {
            tasks.push(deviceTypeService.assignDeviceToCustomer(customerId, deviceId));
        }
