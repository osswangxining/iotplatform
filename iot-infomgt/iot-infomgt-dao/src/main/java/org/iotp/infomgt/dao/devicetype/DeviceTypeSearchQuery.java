...
public class DeviceTypeSearchQuery {
  ...
  public EntityRelationsQuery toEntitySearchQuery() {
    ...
    query.setFilters(Collections
        .singletonList(new EntityTypeFilter(relationType == null ? EntityRelation.CONTAINS_TYPE : relationType,
            Collections.singletonList(ThingType.DEVICETYPE))));
    return query;
  }
}
