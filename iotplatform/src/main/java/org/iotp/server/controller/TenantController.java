...
public class TenantController extends BaseController {
    ...
    @ResponseBody
    public Tenant getTenantById(@PathVariable("tenantId") String strTenantId) throws IoTPException {
    ...
    @ResponseBody 
    public Tenant saveTenant(@RequestBody Tenant tenant) throws IoTPException {
        try {
    ...
    public void deleteTenant(@PathVariable("tenantId") String strTenantId) throws IoTPException {
        checkParameter("tenantId", strTenantId);
        try {
            TenantId tenantId = new TenantId(toUUID(strTenantId));
